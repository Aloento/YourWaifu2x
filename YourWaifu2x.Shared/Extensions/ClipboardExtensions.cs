...
namespace YourWaifu2x
{
    ...
    public class ClipboardExtensions
    {
        ...
        public static CopyTrigger GetCopyTrigger(FrameworkElement obj)
        {
            return (CopyTrigger)obj.GetValue(CopyTriggerProperty);
        }

        public static void SetCopyTrigger(FrameworkElement obj, CopyTrigger value)
        {
            obj.SetValue(CopyTriggerProperty, value);
        }
        ...
        public static string GetCopyContent(FrameworkElement obj)
        {
            return (string)obj.GetValue(CopyContentProperty);
        }

        public static void SetCopyContent(FrameworkElement obj, string value)
        {
            obj.SetValue(CopyContentProperty, value);
        }
        ...
        private static IDisposable GetCopySubscription(FrameworkElement obj)
        {
            return (IDisposable)obj.GetValue(CopySubscriptionProperty);
        }

        private static void SetCopySubscription(FrameworkElement obj, IDisposable value)
        {
            obj.SetValue(CopySubscriptionProperty, value);
        }
        ...
        private static void OnCopyTriggerChanged(FrameworkElement sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                IDisposable disposable = BindCopyHandler(sender, trigger);
        ...
        private static IDisposable BindCopyHandler(FrameworkElement sender, CopyTrigger trigger)
        {
            ...
            void RoutedEventHandler(object s, RoutedEventArgs e)
            {
                SetClipboard(sender);
            }
        }
