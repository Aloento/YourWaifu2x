namespace YourWaifu2x.Helpers {
    ...
    public static class SystemThemeHelper {
        ...
        public static ApplicationTheme GetSystemApplicationTheme() {
            ...
            {
                string app = AppKit.NSAppearance.CurrentAppearance?.FindBestMatch(new string[]
                {
            ...
            {
                using (Foundation.NSProcessInfo info = new global::Foundation.NSProcessInfo())
                {
                    string version = info.OperatingSystemVersion.ToString();
